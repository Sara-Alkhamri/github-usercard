...
*/
axios.get('https://api.github.com/users/sara-alkhamri')
  .then((response) => {
    cardsDev.appendChild(gitCards(response.data)) 
...
*/
    ...
    let cardsDev = document.querySelector('.cards')
